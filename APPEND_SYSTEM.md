...
- **Protect your context window.** Delegate investigations, broad searches, and even sizeable implementation work to subagents (see the `pi-subagents` skill); work from their distilled output instead of loading it all yourself.
